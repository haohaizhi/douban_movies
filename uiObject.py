...
class uiObject:
    ...
    def ui_process(self):
        ...
        # 从排行榜 电影搜索布局开始
        # 容器控件
        labelframe = LabelFrame(root, width=760, height=300, text="搜索电影")
        ...
        treeview.column("影片名字", width=220, anchor='center')  # 表示列,不显示
        treeview.column("影片评分", width=220, anchor='center')
        ...
        T_vote_keyword.insert(0, '这个杀手不太冷')
